# A backup of 'http://www.math.mcmaster.ca/bolker/R/misc/legendx.R', 
# from http://stackoverflow.com/questions/13644149/increasing-the-size-of-the-coloured-squares-on-histogram-legends-in-r
# Only change is the cex.box arg to adjust fill size
